...
{
private:
    static void PrintTransferLogRecordLine(const clsBankClient::stTrnsferLogRecord& TransferLogRecord)
    {
...
public:
    ...
    static void ShowTransferLogScreen()
    {
        ...
        if (vTransferLogRecord.size() == 0)
            ...
            for (const clsBankClient::stTrnsferLogRecord& Record : vTransferLogRecord)
            {
